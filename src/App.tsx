...
function App() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const menuOpen = () => {
        if (!menu || !close || !nav || !navPart1 || !smily) {
          return
        }
      ...
      const heroHeadings = scope.querySelectorAll('.page-1 h1')
    ...
    <div ref={appRef}>
      <nav id="nav">
        <div className="container">
          ...
          <div className="nav-part-2">
            <h4 className="none">SHOP</h4>
            <h4 className="none">CATERING</h4>
            <h4 className="none">DONATE</h4>
            <h4 id="menu-expand">
      ...
      <main>
        <div className="page-1">
          <div className="container">
            <div id="head">
              <h1 id="course">Change</h1>
              <h1 id="course2">
                <span id="the">the </span>
                <span id="course-head">Course</span>
              </h1>
            </div>
